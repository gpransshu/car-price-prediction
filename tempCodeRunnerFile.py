...
wait.until(EC.element_to_be_clickable((By.XPATH, "/html/body/div[2]/div/div[1]/div/main/div/div[1]/ul/li")))

products = []

product = driver.find_elements(By.XPATH, "/html/body/div[2]/div/div[1]/div/main/div/div[1]/ul/li")


for p in product:
    a = p.find_element(By.XPATH,"/html/body/div[2]/div/div[1]/div/main/div/div[1]/ul/li[1]/div[1]/div")#title
    print(a.text)
    #for elem in a:
